...
| **7** | **Centralización de Insumos (SharePoint del Área)** | ⏳ Backlog | Centralizar en un único repositorio/SharePoint institucional los insumos hoy dispersos en OneDrives individuales (`1. EXPERIENCIA DE COMPRA` en el OneDrive de **Janesy Lopez** y `Dotación` en la carpeta de **Rossmery**). **Impacto:** Elimina la dependencia de accesos directos personales y rupturas al rotar personal. |
