...
| **SharePoint Calidad & Power BI Service** | `https://interbankpe.sharepoint.com/sites/InteligenciayExperienciaCanal` | Correo corporativo | **Vanessa Ortega** o **Juan Carlos Mondalgo** | Acceso a insumos compartidos (`ACCION_TOMADA.xlsx`) y al área de trabajo (workspace) en Power BI Service (**CALIDAD de servicios**). |
